 ...
 250 PRINT "INDEPENDENCES, MISSOURI TO OREGON CITY, OREGON IN 1847."
...
1020 GOTO 980
1030 PRINT "HOW MUCH DO YOU WANT TO SPSEND ON CLOTHING";
1040 INPUT C
...
1160 GOTO 830
1170 B=50*B
1180 PRINT "AFTER ALL YOUR PURCHASES, YOU NOW HAVE ";T;T" DOLLARS LEFT"
1190 PRINT
...
1840 PRINT "YOU'D BETTER DO SOME HUNTING OR BUY FOOD SOON!!!!"
1850 F=INT(F)
1860 B=INT(B)
1870 C=INT(C)
1880 M1=INT(M1)
...
3890 PRINT "HEAVY RAINS---TIME AND SUPPLIST LOST"
3910 F=F-10
3920 B=B-500
3930 M1=M1-15
3940 M=M-10*RND(-1)-5
...
5290 PRINT
5300 GOTO 5330
5310 PRINT "THAT WILL BE S4*50 FOR THE TELEGRAPH CHARGE."
5320 PRINT
